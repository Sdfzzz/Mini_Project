...
while True:
    inputt=int(input("exit(0) , product_menu_option(1) , courier_menu_option(2) , order_menu_option(3): "))
    ...
    if inputt == 0:
        ...
        with open ("orders_list.json", "r")as file:
            orders=file.read()
        while True:
            input_user3=int(input("return(o), print(1), create(2), update status(3), update order(4) or delete(5): "))
            if input_user3 == 0:
                break
            elif input_user3 == 1  :
                orders_print()
